...
This version introduces compatibility with [SimpleSAMLphp v2.0](https://simplesamlphp.org/docs/2.0/simplesamlphp-changelog)

### Added

- Support for SimpleSAMLphp v2.0 and above
